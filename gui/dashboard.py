...
from gui.layouts.layouts import MyWindow
from plc.mock_plc_server.mock_plc import pycomm3
from gui.layouts.fault_delay_layout import CurrentFaultDelay
...
from gui.dialogs.dashboard_parameter_manager import ParameterManagerWindow
...
class Dashboard(QMainWindow):
    ...
    def initialise_dashboard(self):
        ...
        self.edit_cyctime_win = TagManagerWindow(json_path="config/plc_custom_user_tags/cycle_time_tags.json")
        self.edit_fault_delay_win = TagManagerWindow(json_path="config/plc_custom_user_tags/fault_delay_tags.json")
        self.edit_station_fault_win = TagManagerWindow(json_path="config/plc_custom_user_tags/station_fault_tags.json")
        self.edit_tip_dress_win = TagManagerWindow(json_path="config/plc_custom_user_tags/tip_dress_tags.json")
        self.edit_tip_change_win = TagManagerWindow(json_path="config/plc_custom_user_tags/tip_dress_tags.json")
        self.edit_dashboard_win = ParameterManagerWindow(json_path="config/plc_custom_user_tags/dashboard_tags.json")
    ...
    def _init_ui(self):
        ...
        data = {}
        self.create_default_config_if_missing("config/plc_custom_user_tags/dashboard_tags.json")
