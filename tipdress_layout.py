...
class Worker(QObject):
    ...
    def __init__(self, tip_dress_count_file, last_tip_dress_file, tip_dress_count_table, last_tip_dress_table):
        super().__init__()
        self.tip_dress_count_file = tip_dress_count_file
        self.last_tip_dress_file = last_tip_dress_file
        self.tip_dress_count_table = tip_dress_count_table
        self.last_tip_dress_table = last_tip_dress_table
    ...
    def load_tip_dress_count_data(self):
        ...
        try:
            ...
            with open("error_log_in_load_tip_dress_count.txt", "a") as file:
    ...
    def load_last_tip_dress_data(self):
        ...
        try:
            ...
            error_message = f"Error occurred: {e}\n"
            print(error_message)  # Print to console
            with open("error_log_in_last_tip_dress.txt", "a") as file:
                file.write(error_message)
        return result
    ...
    def load_data_to_view(self):
        try:
            ...
            error_message = f"Error occurred: File not found\n"
            print(error_message)  # Print to console
...
class TipDressTagWindow(QMainWindow):
    def __init__(self, backup_file=None):
        ...
        if backup_file:
            ...
            self.tip_dress_count_file = f'./{dw.TIP_DRESS_COUNT_DIR}/{backup_file}'
            self.last_tip_dress_file = f'./{dw.LAST_TIP_DRESS_DIR}/{backup_file}'
            ...
            self.worker = Worker(self.tip_dress_count_file, self.last_tip_dress_file, self.tip_dress_count_table, self.last_tip_dress_table)
            self.thread = QThread()
